...
func (x *QueryBalanceRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ReserveRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ReleaseReservationRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AdminCancelOrdersRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *CancelMyOrdersRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
