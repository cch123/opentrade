...
func (x *QueryFundingBalanceRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *QueryTransferRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *QueryTransferResponse) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ListTransfersRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *Transfer) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
const file_rpc_asset_asset_proto_rawDesc = "" +
	...
	"\vtransfer_id\x18\x01 \x01(\tR\n" +
	"transferId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x04R\x06userId\"\xe6\x02\n" +
