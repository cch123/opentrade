...
| `trigger-event` | trigger 主 | user_id | trade-dump | 触发单状态转换的 post-change full snapshot，供长期历史投影（ADR-0047） |
...
周期 snapshot 之后下的触发单）。这是 ADR-0040 / 0042 接受的代价，换
