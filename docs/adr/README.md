...
| [0065](0065-asset-funding-mysql-authority.md) | Funding wallet 以 MySQL 为权威源 | Accepted |
...
| [0070](0070-perp-liquidation-hardening.md) | perp 强平进阶 — 阶梯风险限额 + 部分强平 + 兜底接管 + ADL 自动执行 | Accepted / Implemented |
