...
2. 所有下游 consumer 用 `kgo.FetchIsolationLevel(kgo.ReadCommitted())` —— 仓内 counter / quote / trade-dump / history / push / bff / match / trigger / asset 全部已经是 `read_committed`，ADR-0005 起固化
