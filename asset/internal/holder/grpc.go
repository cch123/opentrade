...
func NewGRPCClient(target string) (*GRPCClient, error) {
	...
	return &GRPCClient{conn: closer, rpc: assetholderrpc.NewAssetHolderConnectClient(httpClient, target)}, nil
}

// NewGRPCClientWithRPC wraps a preconfigured RPC client. The returned
// GRPCClient does not own any transport resources, so Close is a no-op.
func NewGRPCClientWithRPC(rpc assetholderrpc.AssetHolderClient) *GRPCClient {
